...
export default function HomeScreen(props) {
    ...
    return (
        <div className="mt-80 mb-4">
            <div className="mw-800 m-auto mb-2 fs-5">BNB Available For Withdrawal: {(props.userGetMyBnb - 0).toFixed(8)} BNB</div>
            <div className="d-flex mw-800 m-auto">
                <ProgressBar completed={(props.lastHatch) > (24 * 60 * 60) ? 100 : Number((props.lastHatch * 100 / (24 * 60 * 60)).toFixed(2))} className="w-100 progress-bar-m" labelAlignment="outside" borderRadius="5px" />
            </div>
            <div className="mw-800 d-flex m-auto mb-2 style-1 mt-4 justify-content-between fs-2 gap-2">
                ...
                <div>
                    <div>Contract</div>
                    <div>{props.contractBnbAmount ? (props.contractBnbAmount - 0).toFixed(3) : "0"} BNB</div>
                </div>
            </div>
            <div className="d-flex mw-800 justify-content-center m-auto gap-5 flex-column flex-md-row mt-4 mb-5">
                <div className="d-flex flex-column" style={{ flex: 1 }}>
                    ...
                    <div className="style-2">
                        ...
                        <div className="mt-4"><button className="button-2" onClick={props.handleCompound}> Compound with BNB from rewards</button></div>
                ...
                <div className="d-flex flex-column" style={{ flex: 1 }}>
                    ...
                    <div className="style-2">
                        ...
                        {
                            props.web3Provider ? (
                                <div style={{ cursor: "pointer" }} className="button-3 mb-4" onClick={() => { navigator.clipboard.writeText("https://app.safemutual.com/?ref=" + props.account); toast.success('Copied! Share with anyone to earn BNB.'); }}>https://app.safemutual.com/?ref={props.account} <b>(Click to copy)</b>
                                </div>
                            ) : (
                        ...
                        <div className="d-flex gap-4">
                            <button className="button-2" onClick={props.handleClaim}>Claim</button>
                            <button className="button-2" onClick={props.handleCompound}>Compound</button>
                        </div>
                    </div>
                </div>
            </div>
